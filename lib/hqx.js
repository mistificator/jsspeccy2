...
window.hqx = function(src_img, dst_img) {
	...
	var srcPxCount = src_img.width * src_img.height;
	...
	// This is where the magic happens with src and dest arrays
	if( scale === 2 ) hq2x( src_img.width, src_img.height );
	/*
	else if( scale === 3 ) hq3x( src_img.width, src_img.height );
	else if( scale === 4 ) hq4x( src_img.width, src_img.height );
	*/
	// alternative: window['hq'+scale+'x']( src_img.width, src_img.height ); 

	// unpack integers to RGBA
	var c;
	var scaledPixelsData = dst_img.data;

...
w.change(function(){h.settings.checkerboardFilter.set(w.is(":checked"))});"on"!==$.urlPar("hq2x")?w.parent().hide():w.attr("checked",!0);$(".panel button.close",g).click(function(){f()});m=$(".panel.open-file",g);var G=m.find("input[type='file']");G.change(function(){h.loadLocalFile(this.files[0],{autoload:N.is(":checked"),debugPrint:a.debugPrint});G.val("");f()});t&&"on"!==$.urlPar("load_file")&&$("#load_file",g).hide();var A=m.find("input[type='url']");m.find("button.open-url").click(function(){""!==
